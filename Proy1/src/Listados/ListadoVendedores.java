...
public class ListadoVendedores {
    //CREACIÓN DEL DOCUMENTO
    Document documentov = new Document(PageSize.LETTER);
    ...
    private static void Contenido(Document doc) throws DocumentException, IOException{
        ...
        titulo.add(new Paragraph("Listado de Vendedores", Tgrande));
        ...
        //COLUMNA 3 == CAJA        
        PdfPCell columna3 = new PdfPCell(new Phrase("Caja",Tmediano));
        ...
        //COLUMNA 4 == VENTA
        PdfPCell columna4 = new PdfPCell(new Phrase("Ventas",Tmediano));
        ...
        //COLUMNA 5 == GÉNERO
        PdfPCell columna5 = new PdfPCell(new Phrase("Género",Tmediano));
        ...
        for (int i = 0; i < Proy1.cvendedores; i++) {
            if (Proy1.vendedores[i] !=null) {
                //COLUMNA1 = CODIGOS
                columna1 = new PdfPCell(new Phrase(String.valueOf(Proy1.vendedores[i].getCodigo()),Tpequeño));
                columna1.setHorizontalAlignment(Element.ALIGN_CENTER);
                columna1.setVerticalAlignment(Element.ALIGN_MIDDLE);
                columna1.setBorderColor(negro);
                ...
                //COLUMNA2 = NOMBRES
                columna2 = new PdfPCell(new Phrase(Proy1.vendedores[i].getNombre(),Tpequeño));
                columna2.setHorizontalAlignment(Element.ALIGN_CENTER);
                columna2.setVerticalAlignment(Element.ALIGN_MIDDLE);
                columna2.setBorderColor(negro);
                ...
                //COLUMNA3 = CAJAS
                columna3 = new PdfPCell(new Phrase(String.valueOf(Proy1.vendedores[i].getCaja()),Tpequeño));
                columna3.setHorizontalAlignment(Element.ALIGN_CENTER);
                columna3.setVerticalAlignment(Element.ALIGN_MIDDLE);
                columna3.setBorderColor(negro);
                ...
                //COLUMNA4 = VENTAS
                columna4 = new PdfPCell(new Phrase(String.valueOf(Proy1.vendedores[i].getVentas()),Tpequeño));
                columna4.setHorizontalAlignment(Element.ALIGN_CENTER);
                columna4.setVerticalAlignment(Element.ALIGN_MIDDLE);
                columna4.setBorderColor(negro);
                ...
                //COLUMNA5 = GÉNEROS
                columna5 = new PdfPCell(new Phrase(Proy1.vendedores[i].getGenero(),Tpequeño));
                columna5.setHorizontalAlignment(Element.ALIGN_CENTER);
                columna5.setVerticalAlignment(Element.ALIGN_MIDDLE);
                columna5.setBorderColor(negro);
